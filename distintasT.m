%Grafica en la que cambio el número inicial de células T para el escenario
%de Bettina. Grafico el numero de celulas tumorales a lo largo del tiempo
%(unos 18 días)

%% CÓDIGO tfm_empezar HECHO FUNCION

function evolucion = distintasT(nT)
%clear
...
rng('default');
rng(12345); %el numerito es la semilla
