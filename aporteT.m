%Grafica en la que cambio el aporte de células T para el escenario 2. 
% Grafico el numero de celulas tumorales a lo largo del tiempo
%(unos 18 días)

%% CÓDIGO tfm_introducirT HECHO FUNCION

function evolucion = aporteT(flujoT)
